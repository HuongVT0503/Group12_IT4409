            ...
            {loading ? (
              ...
              <tr key={user.userId} className="hover:bg-gray-50/80 transition-colors">
                <td className="px-6 py-4 flex items-center gap-3">
                  <Avatar src={`https://ui-avatars.com/api/?name=${user.username}`} size={9} />
                  <div>
                ...
                <td className="px-6 py-4">
                  {user.isBanned ? (
                    <span className="bg-red-100 text-red-700 px-2 py-1 rounded text-xs font-semibold">Banned</span>
                  ) : (
