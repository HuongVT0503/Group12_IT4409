  ...
  return (
    ...
    >
      {label && (
        <label
          htmlFor={name}
          className="text-base lg:text-lg font-medium text-gray-600 ml-1"
        >
          {label}
        </label>
      )}
      ...
      <div className="relative">
        ...
        {isPassword && (
          ...
          >
            {showPassword ? (
              <Eye className="w-6 h-6 opacity-60 hover:opacity-100 transition-opacity" />
            ) : (
              <EyeOff className="w-6 h-6 opacity-60 hover:opacity-100 transition-opacity" />
            )}
          </button>
        )}
